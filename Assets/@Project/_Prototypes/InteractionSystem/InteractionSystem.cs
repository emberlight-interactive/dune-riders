...
namespace DuneRiders.InteractionSystem {
	...
	abstract class ResponseRequesterBase {
		public abstract void Initiate();
		public abstract void ForceCancel();
	}

	abstract class ResponseRequester<ResultType, TBehaviour> :  ResponseRequesterBase where TBehaviour : ResponseRequestMonoBehaviour<ResultType> {
